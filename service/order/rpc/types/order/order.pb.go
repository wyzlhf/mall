...
var file_service_order_rpc_order_proto_rawDesc = []byte{
	...
	0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0x82, 0x03, 0x0a, 0x05, 0x4f, 0x72,
...
var file_service_order_rpc_order_proto_depIdxs = []int32{
	...
	3,  // 9: order.Order.Update:output_type -> order.UpdateResponse
	5,  // 10: order.Order.Remove:output_type -> order.RemoveResponse
	7,  // 11: order.Order.Detail:output_type -> order.DetailResponse
	9,  // 12: order.Order.List:output_type -> order.ListResponse
	11, // 13: order.Order.Paid:output_type -> order.PaidResponse
	1,  // 14: order.Order.CreateRevert:output_type -> order.CreateResponse
